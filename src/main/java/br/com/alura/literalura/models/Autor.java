...
public class Autor {
    ...
    public String toString() {
        ...
        if (anoNascimento != null) {
            anoNascimentoStr = anoNascimento.toString();
        } else {
            anoNascimentoStr = "Desconhecido";
        }
        String anoFalecimentoStr;
        if (anoFalecimento != null) {
            anoFalecimentoStr = anoFalecimento.toString();
        } else {
            anoFalecimentoStr = "Desconhecido";
        }

        return "Autor: " + this.autor + " (nascido em " + anoNascimentoStr + ", falecido em " + anoFalecimentoStr + ")";
    }
}